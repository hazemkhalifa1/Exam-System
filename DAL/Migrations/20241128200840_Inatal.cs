...
{
    /// <inheritdoc />
    public partial class Inatal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Total_Degree = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Num_Of_Examiners = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
